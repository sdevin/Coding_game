...
void* foncThread(void* fileName){
	char* file = (char*)fileName;
	char name[20];
	FILE* fichier = NULL;
	fichier = fopen(fileName, "r+");
	while(fgets(name, 20, fichier) != NULL){
		name[strcspn(name, "\n")] = '\0';
		char instruction[20];
		instruction[0] = '\0';
...
int main(){
	...
	pthread_create(&idThread1, NULL, foncThread, (void *)"listeFile1.txt");
	pthread_create(&idThread2, NULL, foncThread, (void *)"listeFile2.txt");
